...
CREATE SCHEMA IF NOT EXISTS `library_rolandl` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `library_rolandl` ;

-- -----------------------------------------------------
-- Table `library_rolandl`.`GENRE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library_rolandl`.`GENRE` (
...
-- -----------------------------------------------------
-- Table `library_rolandl`.`AUTEUR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library_rolandl`.`AUTEUR` (
...
-- -----------------------------------------------------
-- Table `library_rolandl`.`LIVRE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library_rolandl`.`LIVRE` (
  ...
  CONSTRAINT `fk_LIVRE_GENRE`
    FOREIGN KEY (`GEN_ID`)
    REFERENCES `library_rolandl`.`GENRE` (`GEN_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LIVRE_AUTEUR1`
    FOREIGN KEY (`AUT_ID`)
    REFERENCES `library_rolandl`.`AUTEUR` (`AUT_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `library_rolandl`.`UTILISATEUR`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library_rolandl`.`UTILISATEUR` (
...
-- -----------------------------------------------------
-- Table `library_rolandl`.`HAS`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library_rolandl`.`HAS` (
  ...
  CONSTRAINT `fk_LIVRE_has_UTILISATEUR_LIVRE1`
    FOREIGN KEY (`LIV_ID`)
    REFERENCES `library_rolandl`.`LIVRE` (`LIV_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_LIVRE_has_UTILISATEUR_UTILISATEUR1`
    FOREIGN KEY (`UTI_ID`)
    REFERENCES `library_rolandl`.`UTILISATEUR` (`UTI_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `library_rolandl`.`WANT`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `library_rolandl`.`WANT` (
  `LIV_ID` INT(11) NOT NULL,
  `UTI_ID` INT(11) NOT NULL,
  PRIMARY KEY (`LIV_ID`, `UTI_ID`),
